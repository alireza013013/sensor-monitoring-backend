...
namespace sensor_monitoring_backend.Migrations
{
    ...
    [Migration("20230627184658_changeTypeList")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sensor_monitoring_backend.Domain.Entities.PacketDecoder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<List<double>>("ByteNumbers")
                        .IsRequired()
                        .HasColumnType("double precision[]");
            ...
            modelBuilder.Entity("sensor_monitoring_backend.Domain.Entity.DeterminedValue", b =>
                {
                    ...
                    b.Property<Guid?>("PacketDecoderId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("sensor_monitoring_backend.Domain.Entities.PacketDecoder", b =>
                {
                    b.HasOne("sensor_monitoring_backend.Domain.Entity.Sensor", "PacketSensor")
                        .WithMany("PacketDecoders")
                        .HasForeignKey("SensorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PacketSensor");
                });

            modelBuilder.Entity("sensor_monitoring_backend.Domain.Entity.DeterminedValue", b =>
                {
                    b.HasOne("sensor_monitoring_backend.Domain.Entities.PacketDecoder", "PacketDecoder")
                        .WithMany("DeterminedValues")
                        .HasForeignKey("PacketDecoderId");

                    b.Navigation("PacketDecoder");
                });
